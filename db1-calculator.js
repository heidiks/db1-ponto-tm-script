    ...
    $(".tabExterna th:last-child, .tabExterna td:last-child").each(function(index) {
        ...
        if(!isFinalDeSemana()) {
            ...
            if(horasTrabalhadas.isValid() && !horasTrabalhadas.isBefore(DIA_FICTICIO + '08:58:00', 'time')) 
                $(this).append("&nbsp;<span class=\"label label-warning\" style=\"font-size:9px\" title=\"Saldo: " + calculaDiferenca($(this).text(), '08:58:00')  +"\">Hora extra!</span>");
                ...
                $(this).append("&nbsp;<span class=\"label label-danger\" style=\"font-size:9px\" title=\"Saldo: " + calculaDiferenca($(this).text(), '08:58:00')  +"\">Jornada abaixo!</span>");
